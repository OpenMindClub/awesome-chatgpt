...
- [BraveGPT 🦁](https://github.com/kudoai/bravegpt) - 将 ChatGPT 的魔力添加到 Brave Search 侧边栏 (由 GPT-4 提供支持!)
...
- [BraveGPT 🦁](https://www.bravegpt.com/greasemonkey) - 将 ChatGPT 的魔力添加到 Brave Search 侧边栏 (由 GPT-4 提供支持!)
